...
// func findCreatedDate(n int) time.Time {
// 	gap := -1 * n
// 	minDate := time.Now().AddDate(0, 0, gap).Unix()
// 	maxDate := time.Now().Unix()
// 	delta := maxDate - minDate

// 	sec := rand.Int63n(delta) + minDate
// 	return time.Unix(sec, 0).Format(RFC3339)
// }

func main() {

	ids := collectRandomId(1000, 27)
	clusterIds := collectRandomId(1000, 32)
	extIds := collectRandomExtId(1000)
//	cDate := findCreatedDate(10).String()
	...
	for i := 0; i < 1000; i++ {
		s := Subscription{ids[i], "Subscription", "/api/accounts_mgmt/v1/subscriptions/1YuEObNEl4Z8b79mbbHD7a9hkl6", p, clusterIds[i], extIds[i], "1Yu9TWVAfvJu9Cj5hbMT6iYkdk8", "2020-03-10T13:53:52.198877Z", "2020-03-10T13:53:52.198877Z", "2020-07-15T22:53:56.796303Z", "None", extIds[i], c, false, "Active", "Telemetry", "2020-03-10T20:43:46.428922Z", "https://console-openshift-console.apps.jdgray-c6mvq.dev01.red-chesterfield.com", "0001-01-01T00:00:00Z", mets, "aws", "us-east-1", "0001-01-01T00:00:00Z"}
		test = append(test, s)
	}
	total := SubscriptionList{"SubscriptionList", 1, 1000, 1000, test}
